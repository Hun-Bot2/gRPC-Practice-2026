...
const file_product_info_proto_rawDesc = "" +
	"\n" +
	"\x12product_info.proto\x12\tecommerce\"e\n" +
	"\aProduct\x12\x0e\n" +
...
var (
	...
	file_product_info_proto_rawDescData []byte
)

func file_product_info_proto_rawDescGZIP() []byte {
	file_product_info_proto_rawDescOnce.Do(func() {
		file_product_info_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_product_info_proto_rawDesc), len(file_product_info_proto_rawDesc)))
	})
...
func file_product_info_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_product_info_proto_rawDesc), len(file_product_info_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
